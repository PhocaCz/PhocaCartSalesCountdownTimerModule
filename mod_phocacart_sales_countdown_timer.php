...
$p['item_title_css']                      = $params->get('item_title_css', '');
$p['item_title_animation']                = $params->get('item_title_animation', '');
$p['item_price_css']                      = $params->get('item_price_css', '');
$p['item_price_animation']                = $params->get('item_price_animation', '');
$p['item_stock_display']                  = $params->get('item_stock_display', 1);
...
$p['item_stock_css']                      = $params->get('item_stock_css', '');
$p['item_stock_animation']                = $params->get('item_stock_animation', '');
$p['item_description_display']            = $params->get('item_description_display', 1);
$p['item_description_css']                = $params->get('item_description_css', '');
...
$p['item_discount_description_css']       = $params->get('item_discount_description_css', '');
...
$p['item_button_css']                     = $params->get('item_button_css', '');
...
$p['item_image1_css']                     = $params->get('item_image1_css', '');
...
$p['item_countdown_css']                  = $params->get('item_countdown_css', '');
